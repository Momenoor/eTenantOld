<div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded mb-3" style="border-radius: 15rem!important">
        <a class="navbar-brand" href="<?php echo e(backpack_url('devtools')); ?>">
        ...
        <div class="collapse navbar-collapse" id="devToolsNavBar">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item">
                    <a class="nav-link text-warning" href="<?php echo e(backpack_url('devtools/model')); ?>">Models <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-warning" href="<?php echo e(backpack_url('devtools/migration')); ?>">Migrations <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link text-warning" href="#" id="newNavbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Backpack 
                    </a>
                    <div class="dropdown-menu" aria-labelledby="newNavbarDropdown">

                        <div class="dropdown-header"><strong>Create:</strong></div>
                        <?php if(config('backpack.devtools.show_future_features')): ?>
                            <a class="dropdown-item disabled" href="#">CRUD</a>
                        <?php endif; ?>
                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#livewire-create-page-modal" data-file-type="page">Page</a>
                        <a class="dropdown-item" href="<?php echo e(backpack_url('devtools/operation/create')); ?>">Operation</a>
                        ...
                        <?php endif; ?>
                        <a class="dropdown-item" href="<?php echo e(backpack_url('devtools/operation')); ?>">Operations</a>
                    </div>
                </li>
            </ul>
...
<?php echo $__env->make('backpack.devtools::livewire.partials.assets', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH C:\wamp64\www\eTenant\vendor\backpack\devtools\src/../resources/views/widgets/menu.blade.php ENDPATH**/ ?>