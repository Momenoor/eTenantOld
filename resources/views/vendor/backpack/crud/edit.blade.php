    ...
    <div class="d-flex flex-stack flex-row-fluid">
        ...
        <div class="d-flex flex-column flex-row-fluid">
            <h2>
                ...
                <small class="text-muted mt-1 fw-semibold fs-7">{!! $crud->getSubheading() ?? trans('backpack::crud.edit') . ' ' . $crud->entity_name !!}.</small>

                @if ($crud->hasAccess('list'))
                    <small class="text-muted mt-1 fw-semibold fs-7"><a href="{{ url($crud->route) }}"
